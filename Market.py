...
def makeplotportfolio(valuestockarray, pricedatadftesting, InitialCapital):
    returns_series = pd.Series(valuestockarray)
    ...
    barlist = ax.bar(pricedatadftesting.index.tolist(), list_returns, label='Monthly Returns (%)', width=20)
